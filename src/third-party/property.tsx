...
export type IPropertyProps = {
	readonly propertyId?: string;
	readonly schema?: Omit<types.CollectionPropertySchema, 'type'> & {
		type: PropertyType;
	};
	readonly data?: types.Decoration[];
	readonly block?: types.Block;
	readonly collection?: types.Collection;
	readonly inline?: boolean;
	readonly linkToTitlePage?: boolean;
		...
		() =>
			function NumberProperty() {
				...
				switch (schema.number_format) {
					...
					case 'dollar': {
						output = formatNumber({padRight: 2, prefix: '$', round: 2})(value);
					...
					case 'yuan': {
						output = formatNumber({padRight: 2, prefix: 'CN¥', round: 2})(
							value,
						);
